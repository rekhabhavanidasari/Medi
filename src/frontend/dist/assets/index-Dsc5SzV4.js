...
function generatePharmacies(baseLat, baseLng) {
...
function generateHospitals(baseLat, baseLng) {
  return HOSPITAL_NAMES.map((name, i) => {
    ...
    return {
      ...
      phone: `+91 40-${Math.floor(Math.random() * 9e7) + 1e7}`,
      lat,
      lng,
      dist,
      isOpen,
...
function App() {
  const [userLat, setUserLat] = reactExports.useState(17.385);
  const [userLng, setUserLng] = reactExports.useState(78.4867);
  const [locText, setLocText] = reactExports.useState("Hyderabad, Telangana, India");
  ...
  const [panelTitle, setPanelTitle] = reactExports.useState("Nearby Pharmacies");
  const [resultCount, setResultCount] = reactExports.useState("0 results");
  const [statPharm, setStatPharm] = reactExports.useState("248");
  ...
  const [regStep, setRegStep] = reactExports.useState(1);
  const [regSuccessScreen, setRegSuccessScreen] = reactExports.useState(false);
  const [regIdBadge, setRegIdBadge] = reactExports.useState("");
  ...
  const [loginSubmitting, setLoginSubmitting] = reactExports.useState(false);
  const [loginSuccess, setLoginSuccess] = reactExports.useState(false);
  const [loginEmailErr, setLoginEmailErr] = reactExports.useState(false);
  const [loginPwErr, setLoginPwErr] = reactExports.useState(false);
  const [regFullname, setRegFullname] = reactExports.useState("");
  const [regEmail, setRegEmail] = reactExports.useState("");
  const [regMobile, setRegMobile] = reactExports.useState("");
  const [regPw, setRegPw] = reactExports.useState("");
  const [showRegPw, setShowRegPw] = reactExports.useState(false);
  const [regTerms, setRegTerms] = reactExports.useState(false);
  const [selectedRole, setSelectedRole] = reactExports.useState("owner");
  const [regSubmitting, setRegSubmitting] = reactExports.useState(false);
  const [registerSuccess, setRegisterSuccess] = reactExports.useState(false);
  const [regFullnameErr, setRegFullnameErr] = reactExports.useState(false);
  const [regEmailErr, setRegEmailErr] = reactExports.useState(false);
  const [regMobileErr, setRegMobileErr] = reactExports.useState(false);
  const [regPwErr, setRegPwErr] = reactExports.useState(false);
  const [regTermsErr, setRegTermsErr] = reactExports.useState(false);
  const [pwScore, setPwScore] = reactExports.useState(0);
  ...
  const [regHours, setRegHours] = reactExports.useState("");
  const [regLicense, setRegLicense] = reactExports.useState("");
  const [regOwner, setRegOwner] = reactExports.useState("");
  const [regLat, setRegLat] = reactExports.useState("");
  const [regLng, setRegLng] = reactExports.useState("");
  const [regDist, setRegDist] = reactExports.useState("");
  const [regArea, setRegArea] = reactExports.useState("");
  const [regNotes, setRegNotes] = reactExports.useState("");
  const [availTags, setAvailTags] = reactExports.useState([]);
  const [lowTags, setLowTags] = reactExports.useState([]);
  const [outTags, setOutTags] = reactExports.useState([]);
  const [availInput, setAvailInput] = reactExports.useState("");
  const [lowInput, setLowInput] = reactExports.useState("");
  const [outInput, setOutInput] = reactExports.useState("");
  const [regNameErr, setRegNameErr] = reactExports.useState(false);
  const [regAddressErr, setRegAddressErr] = reactExports.useState(false);
  const [regLatErr, setRegLatErr] = reactExports.useState(false);
  const [regLngErr, setRegLngErr] = reactExports.useState(false);
  const [regDistErr, setRegDistErr] = reactExports.useState(false);
  const [regAvailErr, setRegAvailErr] = reactExports.useState(false);
  const [regSubmittingPharm, setRegSubmittingPharm] = reactExports.useState(false);
  const [routeInfo, setRouteInfo] = reactExports.useState(null);
  const [emergencyRoute, setEmergencyRoute] = reactExports.useState(null);
  const [showCamModal, setShowCamModal] = reactExports.useState(false);
  const [camStatus, setCamStatus] = reactExports.useState("");
  const [micActive, setMicActive] = reactExports.useState(false);
  const [showMicWave, setShowMicWave] = reactExports.useState(false);
  const mapContainerRef = reactExports.useRef(null);
  const mapRef = reactExports.useRef(null);
  const userMarkerRef = reactExports.useRef(null);
  const pharmacyMarkersRef = reactExports.useRef([]);
  const routeLayerRef = reactExports.useRef(null);
  const emergencyMapContainerRef = reactExports.useRef(null);
  const emergencyMapRef = reactExports.useRef(null);
  const emergencyRouteRef = reactExports.useRef(null);
  const miniMapContainerRef = reactExports.useRef(null);
  const miniMapRef = reactExports.useRef(null);
  const miniMarkerRef = reactExports.useRef(null);
  const camStreamRef = reactExports.useRef(null);
  const camVideoRef = reactExports.useRef(null);
  const recognitionRef = reactExports.useRef(null);
  const navAddWrapRef = reactExports.useRef(null);
  const toastTimerRef = reactExports.useRef(null);
  const pharmacyDataRef = reactExports.useRef({});
  ...
  reactExports.useEffect(() => {
    function handler(e) {
      if (navAddWrapRef.current && !navAddWrapRef.current.contains(e.target)) {
      ...
      setTimeout(() => {
        if (emergencyMapContainerRef.current && !emergencyMapRef.current) {
          try {
            ...
            L.marker([userLat, userLng], { icon: uIcon }).bindPopup("<b>📍 Your Location</b>").addTo(emergencyMapRef.current);
  ...
  function placeUserMarker(lat, lng) {
    ...
    userMarkerRef.current = L.marker([lat, lng], { icon }).bindPopup("<b>📍 Your Location</b>").addTo(mapRef.current);
  }
  function showPharmaciesOnMap(pharmacies) {
    if (!mapRef.current) return;
  ...
  function showRouteOnMap(pharmacy) {
    if (!mapRef.current) return;
    if (routeLayerRef.current) {
      mapRef.current.removeLayer(routeLayerRef.current);
      routeLayerRef.current = null;
  ...
  function searchMedicine() {
    ...
    setTimeout(() => {
      ...
      pharmacyDataRef.current = results.reduce((acc, p) => {
        acc[p.id] = p;
        return acc;
      }, {});
  ...
  function validateRegStep(step) {
    ...
    if (step === 2) {
      const lat = Number.parseFloat(regLat), lng = Number.parseFloat(regLng), dist = Number.parseFloat(regDist);
  ...
  function submitRegistration() {
    ...
    setTimeout(() => {
      const id = "MSP-" + Math.floor(1e5 + Math.random() * 9e5);
      setRegIdBadge(`ID: ${id}`);
  ...
  function useCurrentLocationForReg() {
    ...
    navigator.geolocation.getCurrentPosition(
      (pos) => {
        ...
        const d = Math.sqrt(Math.pow(lat - 17.385, 2) + Math.pow(lng - 78.4867, 2)) * 111;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "content-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { className: "logo-wrap", href: "#", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logo-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              viewBox: "0 0 32 32",
              fill: "none",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "logo-text", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Medi" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Spot" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "nav-tagline", children: "🇮🇳 Connecting India to Medicines" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "nav-right", children: [
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "svg",
                  {
                    ...
                    strokeWidth: "2.5",
                    strokeLinecap: "round",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M22 16.92v3a2 2 0 0 1-2.18 2A19.79 19.79 0 0 1 2.08 5.18 2 2 0 0 1 4 3h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 10.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 17.92z" })
                  }
                ),
                "🚨 Emergency"
              ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "nav-add-wrap", ref: navAddWrapRef, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  "Add Pharmacy",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "chevron", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "svg",
                    {
                      width: "13",
                      height: "13",
            ...
            showAddDropdown && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "add-dropdown", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dropdown-header", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Pharmacy Portal" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "Join MediSpot Network" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "di-icon blue", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "svg",
                      {
                        width: "18",
                        height: "18",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "di-title", children: "Login" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "di-sub", children: "Access your pharmacy dashboard" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "di-arrow", children: "›" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "di-icon green", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "svg",
                      {
                        width: "18",
                        height: "18",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "di-title", children: "Register Pharmacy" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "di-sub", children: "List your pharmacy for free" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "di-arrow", children: "›" })
                  ]
                }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-badge", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "12", height: "12", viewBox: "0 0 12 12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "6", cy: "6", r: "5", fill: "#1a6fc4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "path",
              {
                d: "M3.5 6h5M6 3.5v5",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { children: [
          "Find ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Any Medicine" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "At Pharmacies Near You"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Search thousands of medicines across local pharmacies. Know availability, get directions, and never miss a dose." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-box", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "search-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                width: "20",
                height: "20",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "16.5", y1: "16.5", x2: "22", y2: "22" })
                ]
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                ...
                onChange: (e) => {
                  ...
                  setSuggestions(
                    MEDICINES.filter(
                      (m) => m.toLowerCase().includes(q.toLowerCase())
                    ).slice(0, 6)
                  );
                },
                onKeyDown: (e) => {
            ...
            showMicWave && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mic-wave", children: [
                ...
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "svg",
                    {
                      ...
                      strokeLinecap: "round",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "9", y: "2", width: "6", height: "11", rx: "3" }),
          ...
          suggestions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "suggestions", children: suggestions.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "sugg-item",
              onClick: () => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "location-bar", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loc-dot" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "loc-text", children: [
            "Your location: ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: locText })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "loc-btn", onClick: detectLocation, children: "📍 Update Location" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stats-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stat-icon blue", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              width: "22",
              height: "22",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stat-num", children: statPharm }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stat-lbl", children: "Pharmacies in Network" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stat-icon green", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              width: "22",
              height: "22",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stat-num", children: "5,800+" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stat-lbl", children: "Medicines Tracked" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stat-icon red", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              width: "22",
              height: "22",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stat-num", children: "Live" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stat-lbl", children: "Real-Time Inventory" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main-layout", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "panel-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "panel-title", children: panelTitle }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "result-count", children: resultCount })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "filter-row", children: ["all", "available", "out", "nearby"].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              className: `filter-btn${currentFilter === f ? " active" : ""}`,
              "data-ocid": `filter.${f}_tab`,
              onClick: () => setCurrentFilter(f),
              children: f === "all" ? "All" : f === "available" ? "✓ Available" : f === "out" ? "✗ Out of Stock" : "📍 Nearest"
            },
            f
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "resultsContainer", children: loading ? [0, 1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                ...
                strokeLinecap: "round",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "28", cy: "28", r: "18" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "41", y1: "41", x2: "56", y2: "56" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "22", y1: "28", x2: "34", y2: "28" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "28", y1: "22", x2: "28", y2: "34" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: allResults.length === 0 ? "Search for a Medicine" : "No results for this filter" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: allResults.length === 0 ? "Enter any medicine name to find nearby pharmacies." : "Try changing the filter above." })
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-top", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pharm-name", children: p.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pharm-type", children: [
                      "📍 ",
                      p.area,
                      "  ·  ⭐ ",
                      p.rating
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: p.available ? "✓ Available" : "✗ Out of Stock"
                      }
                    ),
                    p.available && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stock-qty", children: [
                      "Stock: ",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "info-item", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "svg",
                      {
                        ...
                        strokeWidth: "2.5",
                        strokeLinecap: "round",
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21" })
                      }
                    ),
                    p.dist,
                    " km away"
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "info-item", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "svg",
                      {
                        ...
                        strokeLinecap: "round",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M2 3h4l2 5-2.5 1.5a11 11 0 0 0 5 5L12 12l5 2v4" })
                        ]
                      }
                    ),
                    p.phone
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "svg",
                          {
                            ...
                            strokeLinecap: "round",
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "9", y1: "3", x2: "9", y2: "18" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "15", y1: "6", x2: "15", y2: "21" })
                            ]
                          }
                        ),
                        "Get Route"
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "map-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "map-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "map-header", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Pharmacy Map" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          routeInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "route-info", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "route-stat", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "val", children: routeInfo.dist }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lbl", children: "Distance" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "route-stat", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "val", children: routeInfo.time }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lbl", children: "Est. Travel" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "route-dest", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: routeInfo.dest }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: routeInfo.addr })
            ] })
          ] })
        ] }) })
      ] })
    ] }),
    showCamModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cam-modal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cam-box", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "📷 Scan Medicine Label" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          style: {
          ...
          children: "Point your camera at the medicine name or packaging"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "video",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cam-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-capture", onClick: captureFrame, children: "📸 Capture & Search" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-close-cam", onClick: closeCamera, children: "Cancel" })
      ] })
    ] }) }),
    showToast && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "toast", children: toastMsg }),
    showAuthModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-modal", "data-ocid": "auth.modal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-close-row", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-body", children: authTab === "login" ? loginSuccess ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-success", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-success-icon", children: "✅" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Logged In Successfully!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Welcome back! Redirecting to your pharmacy dashboard…" })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-icon-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-icon login-icon", children: "🔑" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-title", children: "Welcome Back" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-sub", children: "Sign in to manage your pharmacy inventory" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-field", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-label", children: "Email Address" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
              ...
              loginEmailErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-err", children: "Please enter a valid email" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-field", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-label", children: "Password" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "password-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
              ...
              loginPwErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-err", children: "Please enter your password" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onClick: submitLogin,
                children: loginSubmitting ? "Signing in…" : "Sign In to Dashboard"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-divider", children: "or continue with" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-social", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-switch", children: [
              "Don't have an account?",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { onClick: () => setAuthTab("register"), children: "Register your pharmacy →" })
            ] })
          ] }) : registerSuccess ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-success", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-success-icon", children: "🎉" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Account Created!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Welcome to MediSpot! Check your email to verify your account." })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-icon-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-icon reg-icon", children: "🏥" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-title", children: "Register Your Pharmacy" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-sub", children: "Join 248+ pharmacies on MediSpot network" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "role-selector", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "role-emoji", children: "👨‍⚕️" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "role-name", children: "Pharmacy Owner" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "role-desc", children: "I own / manage" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "role-emoji", children: "💊" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "role-name", children: "Pharmacist Staff" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "role-desc", children: "I work here" })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-field", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-label", children: "Full Name" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
              ...
              regFullnameErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-err", children: "Please enter your full name" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-field", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-label", children: "Email Address" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              regEmailErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-err", children: "Please enter a valid email" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-field", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-label", children: "Mobile Number" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
              ...
              regMobileErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-err", children: "Please enter a valid mobile number" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-field", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-label", children: "Create Password" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "password-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
              ...
              regPwErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-err", children: "Password must be at least 8 characters" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pw-strength-bars", children: [0, 1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "pw-strength-bar",
                  style: {
                    background: i < pwScore ? ["#e83b3b", "#e65100", "#f59e0b", "#1db87e"][pwScore - 1] : void 0
                  }
                },
                i
              )) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "auth-terms", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "checkbox",
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { onClick: () => toast("Terms page coming soon"), children: "Terms of Service" }),
              " ",
              "and",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { onClick: () => toast("Privacy page coming soon"), children: "Privacy Policy" })
            ] }),
            regTermsErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-err", children: "Please accept the terms to continue" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: regSubmitting ? "Creating account…" : "Create Pharmacy Account →"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-switch", style: { marginTop: "14px" }, children: [
              "Already registered?",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { onClick: () => setAuthTab("login"), children: "← Sign in here" })
            ] })
          ] }) })
        ] })
      }
    ),
    showRegModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reg-modal", "data-ocid": "register_pharmacy.modal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reg-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reg-header-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reg-header-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
                  width: "22",
                  height: "22",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Register Pharmacy" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Join MediSpot's network across India" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reg-body", children: !regSuccessScreen ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reg-steps", children: [1, 2, 3].map((s, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "step-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `step-circle${regStep === s ? " active" : regStep > s ? " done" : ""}`,
                    children: regStep > s ? "✓" : s
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      color: regStep === s ? "var(--blue)" : regStep > s ? "var(--green)" : "var(--muted)"
                    },
                    children: ["Basic Info", "Location", "Inventory"][idx]
                  }
                )
              ] }, s),
            ...
            regStep === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-section", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
                ...
                regNameErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "err-msg", children: "Please enter the pharmacy name" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-label", children: [
                  "Address ",
                ...
                regAddressErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "err-msg", children: "Please enter the pharmacy address" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-label", children: [
                    "Phone ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opt", children: "(optional)" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
            ...
            regStep === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-section", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-label", children: [
                    "Latitude ",
                  ...
                  regLatErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "err-msg", children: "Please enter a valid latitude" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-label", children: [
                    "Longitude ",
                  ...
                  regLngErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "err-msg", children: "Please enter a valid longitude" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
                  ...
                  regDistErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "err-msg", children: "Please enter a valid distance" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-label", children: "Area / Locality" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      className: "form-input",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: "📍 Auto-fill from My Current Location"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: miniMapContainerRef, className: "mini-map" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  style: {
                  ...
                  children: "💡 Click the map to pin exact location"
                }
              )
            ] }),
            regStep === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-section", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tag-input-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                      ...
                      children: availTags.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "tag available-tag", children: [
                        t,
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                    ...
                    "input",
                    {
                      ...
                      onKeyDown: (e) => {
                        if (e.key === "Enter" || e.key === ",") {
                          ...
                          setAvailInput("");
                        } else if (e.key === "Backspace" && !availInput && availTags.length) {
                ...
                regAvailErr && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "err-msg", children: "Add at least one available medicine" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tag-hint", children: "Press Enter or , to add" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tag-input-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: lowTags.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "tag low-tag", children: [
                        t,
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                    ...
                    "input",
                    {
                      ...
                      onKeyDown: (e) => {
                        if (e.key === "Enter" || e.key === ",") {
                          ...
                          addTag("low", lowInput);
                          setLowInput("");
                        } else if (e.key === "Backspace" && !lowInput && lowTags.length) {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tag-input-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: outTags.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "tag out-tag", children: [
                        t,
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                    ...
                    "input",
                    {
                      ...
                      onKeyDown: (e) => {
                        if (e.key === "Enter" || e.key === ",") {
                          ...
                          addTag("out", outInput);
                          setOutInput("");
                        } else if (e.key === "Backspace" && !outInput && outTags.length) {
          ...
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reg-success-screen", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "success-icon", children: "🎉" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Pharmacy Registered!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Your pharmacy has been successfully added to MediSpot's network. It will appear after verification (usually within 2 hours)." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reg-id-badge", children: regIdBadge }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
          ...
          !regSuccessScreen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reg-footer", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "step-indicator", children: [
              "Step ",
              regStep,
              " of 3"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  regStep < 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn-next", onClick: regNext, children: [
                    "Next →",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "svg",
                  ...
                  regStep === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        ...
                        regSubmittingPharm ? "Registering…" : "Register Pharmacy"
                      ]
                    }
                  )
                ]
    ...
    showEmergency && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "emergency-modal", "data-ocid": "emergency.modal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "emergency-modal-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "emergency-modal-header-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "emergency-modal-header-icon", children: "🚨" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Nearest Hospitals" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Emergency services near your location – sorted by distance" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "emergency-body", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hospital-list", children: hospitals.map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hosp-top", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hosp-name", children: h.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hosp-type", children: h.type })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: h.isOpen ? "hosp-open-badge" : "hosp-closed-badge",
                        children: h.isOpen ? "● Open Now" : "✕ Closed"
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hosp-info", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "emergency-map-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "emergency-map-div", ref: emergencyMapContainerRef }),
              emergencyRoute && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "emergency-route-strip", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "val", children: emergencyRoute.dist }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lbl", children: "Distance" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "val", children: emergencyRoute.time }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lbl", children: "Est. Travel" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "emergency-route-dest", children: /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: emergencyRoute.dest }) })
              ] })
            ] })
          ] })
        ] })
